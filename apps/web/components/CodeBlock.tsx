export function CodeBlock({
  ...
  return (
    <figure className="overflow-hidden rounded-lg border border-ink-800 bg-ink-900/50 backdrop-blur">
      ...
      <pre className="overflow-x-auto px-4 py-4 text-[13px] leading-relaxed text-ink-100 font-mono">
        <code>{children}</code>
      </pre>
    </figure>
  );
